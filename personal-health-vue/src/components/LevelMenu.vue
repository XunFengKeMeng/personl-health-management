<template>
    <div class="nav">
        ...
        <!-- 路由children列表显示 -->
        <div :style="{color: selectedIndex === index ? '#1c1c1c' : 'rgb(102 102 102)'}"
        ...
        <!-- <div class="record">
            <span @click="healthRecord" style="margin:14px 10px;">
        ...
        <div>
            <el-dropdown class="user-dropdown">
                <span class="el-dropdown-link" style="display: flex; align-items: center;">
                    <el-avatar :size="35" :src="require('@/assets/img/user.png')" style="margin-top: 0; background-color: #e9e9e9;"></el-avatar>
                    <span class="userName" style="margin-left: 5px;font-size: 15px;">{{ userInfo.name }}</span>
